...
<body>
 	...
 	<form method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
            ...
            <input name="pokemon" placeholder="Bulbasaur">
 ...
 <?php   
    ...
    if (isset($_POST["submit"])){ 
    	$to = "btg5907@rit.edu"; // !!! REPLACE WITH YOUR EMAIL !!!
    	...
    	// else, use the value from the form field
			...
			// #5.5 - same as above, except with the 'pokemon' form field
			$pokemon = empty(trim($_POST["pokemon"])) ? "Shuckle" : sanitize_string($_POST["pokemon"]);
			
			$headers = "From: $from" . "\r\n";
			
			// #6 - add the user's name to the end of the message
			$message .= "\n\n - $name, fan of $pokemon" . "s";
